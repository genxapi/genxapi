...
This workspace contains the generated API client for __PROJECT_NAME__, produced by `@eduardoac/generate-api-client`. It ships with Kubb, Rollup, and TypeScript tooling so the client can be regenerated, tested, and published with minimal setup.
