...
This workspace contains the generated API client for __PROJECT_NAME__, produced by `@genxapi/cli`. It ships with Orval, Rollup, and TypeScript tooling so the client can be regenerated, tested, and published with minimal setup.
